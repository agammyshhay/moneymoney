...
const accountIdToDisplayName: Record<CompanyTypes, string> & Partial<Record<OutputVendorName, string>> = {
...
const accountMetadata = mapValues(accountIdToDisplayName, (displayName, accountId) => {
  return {
    companyId: accountId,
    companyName: displayName!,
    logo: icons[accountId as CompanyTypes | OutputVendorName],
  };
}) as Record<CompanyTypes | OutputVendorName, AccountMetadata>;
...
export const exporterUIHandlers: Partial<Record<OutputVendorName, ExportResultMetadata>> = {
